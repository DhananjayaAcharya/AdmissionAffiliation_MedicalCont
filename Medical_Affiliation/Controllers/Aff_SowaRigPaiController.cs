...
{
    public class Aff_SowaRigPaiController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Aff_SowaRigPaiController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult SowaRigPai_BasicDetails()
        {
        ...
        public IActionResult SowaRigPai_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("SowaRigPai_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult SowaRigPai_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        public IActionResult NextStep()
        {
            ...
            return RedirectToAction("SowaRigPai_BasicDetails");
        }


        [HttpGet]
        public async Task<IActionResult> SowaRigPai_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> SowaRigPai_UGPG(Ayurveda_FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(SowaRigPai_UGPG));
        }


        [HttpGet]
        public IActionResult SowaRigPai_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("SowaRigPai_YearwiseMaterials");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult SowaRigPai_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public IActionResult SowaRigPai_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult SowaRigPai_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("SowaRigPai_FacultyDetails");
        }


        [HttpGet]
        public IActionResult SowaRigPai_FacultyDetails()
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult SowaRigPai_FacultyDetails(IList<FacultyDetailsViewModel> model)
        {
            string collegeCode = HttpContext.Session.GetString("CollegeCode");
            string facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    return RedirectToAction("SowaRigPaiExamResults");
                }
                catch (Exception ex)
                {
        ...
        [HttpGet]
        public async Task<IActionResult> SowaRigPaiExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> SowaRigPaiExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(SowaRigPaiExamResults));
            }
            catch (Exception ex)
            {
