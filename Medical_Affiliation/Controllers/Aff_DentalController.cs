...
{
    public class Aff_DentalController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Aff_DentalController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult Dental_BasicDetails()
        {
        ...
        public IActionResult Dental_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("Dental_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult Dental_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public async Task<IActionResult> Dental_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpGet]
        public IActionResult Dental_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("Dental_YearwiseMaterials");
        }

        // POST: FacultyIntake/Create
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Dental_UGPG(FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(Dental_UGPG));
        }
        ...
        [HttpGet]
        public IActionResult Dental_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult Dental_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("Dental_FacultyDetails");
        }


//        [HttpGet]
//        public IActionResult Dental_FacultyDetails()
//        {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public IActionResult Dental_FacultyDetails(IList<FacultyDetailsViewModel> model)
//        {
//            string collegeCode = HttpContext.Session.GetString("CollegeCode");
//            string facultyCode = HttpContext.Session.GetString("FacultyCode");
...
//                    return RedirectToAction("DentalExamResults");
//                }
//                catch (Exception ex)
//                {
...
//        }
        ...
        [HttpGet]
        public async Task<IActionResult> DentalExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> DentalExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(DentalExamResults));
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Dental_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
