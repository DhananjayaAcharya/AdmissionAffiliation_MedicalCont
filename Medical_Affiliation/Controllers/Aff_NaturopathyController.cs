...
{
    public class Aff_NaturopathyController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Aff_NaturopathyController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult Naturopathy_BasicDetails()
        {
        ...
        public IActionResult Naturopathy_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("Naturopathy_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult Naturopathy_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public async Task<IActionResult> Naturopathy_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Naturopathy_UGPG(Ayurveda_FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(Naturopathy_UGPG));
        }


        [HttpGet]
        public IActionResult Naturopathy_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("Naturopathy_YearwiseMaterials");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Naturopathy_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public IActionResult Naturopathy_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult Naturopathy_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("Naturopathy_FacultyDetails");
        }


        //[HttpGet]
        //public IActionResult Naturopathy_FacultyDetails()
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public IActionResult Naturopathy_FacultyDetails(IList<FacultyDetailsViewModel> model)
        //{
        //    string collegeCode = HttpContext.Session.GetString("CollegeCode");
        //    string facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        //            return RedirectToAction("NaturopathyExamResults");
        //        }
        //        catch (Exception ex)
        //        {
        ...
        [HttpGet]
        public async Task<IActionResult> NaturopathyExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> NaturopathyExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(NaturopathyExamResults));
            }
            catch (Exception ex)
            {
