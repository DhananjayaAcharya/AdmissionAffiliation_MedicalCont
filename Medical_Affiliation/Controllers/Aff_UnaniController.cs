...
{
    public class Aff_UnaniController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Aff_UnaniController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult Unani_BasicDetails()
        {
        ...
        public IActionResult Unani_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("Unani_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult Unani_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public async Task<IActionResult> Unani_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Unani_UGPG(Ayurveda_FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(Unani_UGPG));
        }


        [HttpGet]
        public IActionResult Unani_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("Unani_YearwiseMaterials");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Unani_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public IActionResult Unani_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult Unani_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("Unani_FacultyDetails");
        }


        [HttpGet]
        public IActionResult Unani_FacultyDetails()
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Unani_FacultyDetails(IList<FacultyDetailsViewModel> model)
        {
            string collegeCode = HttpContext.Session.GetString("CollegeCode");
            string facultyCode = HttpContext.Session.GetString("FacultyCode");
                ...
                model = new List<FacultyDetailsViewModel>
{
     new FacultyDetailsViewModel
     {
         ...
         DepartmentDetails = _context.MstCourses
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    return RedirectToAction("UnaniExamResults");
                }
                catch (Exception ex)
                {
        ...
        [HttpGet]
        public async Task<IActionResult> UnaniExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> UnaniExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(UnaniExamResults));
            }
            catch (Exception ex)
            {
