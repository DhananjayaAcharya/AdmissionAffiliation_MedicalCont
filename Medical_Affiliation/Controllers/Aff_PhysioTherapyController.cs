...
{
    public class Aff_PhysioTherapyController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Aff_PhysioTherapyController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult PhysioTherapy_BasicDetails()
        {
        ...
        public IActionResult PhysioTherapy_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("PhysioTherapy_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult PhysioTherapy_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public async Task<IActionResult> PhysioTherapy_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> PhysioTherapy_UGPG(Ayurveda_FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(PhysioTherapy_UGPG));
        }


        [HttpGet]
        public IActionResult PhysioTherapy_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("PhysioTherapy_YearwiseMaterials");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult PhysioTherapy_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public IActionResult PhysioTherapy_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult PhysioTherapy_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("PhysioTherapy_FacultyDetails");
        }
...
//        }
        ...
        [HttpGet]
        public async Task<IActionResult> PhysioTherapyExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> PhysioTherapyExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(PhysioTherapyExamResults));
            }
            catch (Exception ex)
            {
