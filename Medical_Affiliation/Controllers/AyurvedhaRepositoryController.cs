...
{
    public class AyurvedhaRepositoryController : Controller
    {
        private readonly ApplicationDbContext _context;

        public AyurvedhaRepositoryController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult Ayurvedha_BasicDetails()
        {
        ...
        public IActionResult Ayurvedha_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("Ayurvedha_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult Ayurvedha_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public async Task<IActionResult> Ayurvedha_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Ayurvedha_UGPG(Ayurveda_FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(Ayurvedha_UGPG));
        }


        [HttpGet]
        public IActionResult Ayurvedha_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("Ayurvedha_YearwiseMaterials");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Ayurvedha_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public IActionResult Ayurvedha_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult Ayurvedha_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("Ayurvedha_FacultyDetails");
        }


        //[HttpGet]
        //public IActionResult Ayurvedha_FacultyDetails()
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public IActionResult Ayurvedha_FacultyDetails(IList<FacultyDetailsViewModel> model)
        //{
        //    string collegeCode = HttpContext.Session.GetString("CollegeCode");
        //    string facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        //            return RedirectToAction("AyurvedhaExamResults");
        //        }
        //        catch (Exception ex)
        //        {
        ...
        [HttpGet]
        public async Task<IActionResult> AyurvedhaExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> AyurvedhaExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(AyurvedhaExamResults));
            }
            catch (Exception ex)
            {
