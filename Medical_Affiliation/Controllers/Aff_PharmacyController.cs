...
{
    public class Aff_PharmacyController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Aff_PharmacyController(ApplicationDbContext context)
        {
            _context = context;
        }

        [HttpGet]
        public IActionResult Pharmacy_BasicDetails()
        {
        ...
        public IActionResult Pharmacy_BasicDetails(NursingInstituteDetailViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCodeString = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction("Pharmacy_UGPG");
        }
        ...
        [HttpGet]
        public IActionResult Pharmacy_Institute_Report()
        {
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            if (model == null)
                return RedirectToAction("Pharmacy_BasicDetails");
        ...
        [HttpGet]
        public async Task<IActionResult> Pharmacy_UGPG()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode") ?? "";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Pharmacy_UGPG(AHS_FacultyIntakeViewModel model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            return RedirectToAction(nameof(Pharmacy_UGPG));
        }


        [HttpGet]
        public IActionResult Pharmacy_YearwiseMaterials()
        {
            try
            {
                var collegeCode = HttpContext.Session.GetString("CollegeCode");
     ...
     .Select(y => new
     {
        ...
        public IActionResult DeleteYearwiseMaterial1(int parametersId)
        {
            ...
            return RedirectToAction("Pharmacy_YearwiseMaterials");
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Pharmacy_YearwiseMaterials(List<YearwiseMaterialViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpGet]
        public IActionResult Pharmacy_ManageDesignationIntake()
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
        ...
        [HttpPost]
        public IActionResult Pharmacy_ManageDesignationIntake(List<CollegeDesignationDetailsViewModel> model)
        {
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            var facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            _context.SaveChanges();
            return RedirectToAction("Pharmacy_FacultyDetails");
        }


        [HttpGet]
        public IActionResult Pharmacy_FacultyDetails()
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Pharmacy_FacultyDetails(IList<FacultyDetailsViewModel> model)
        {
            string collegeCode = HttpContext.Session.GetString("CollegeCode");
            string facultyCode = HttpContext.Session.GetString("FacultyCode");
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                try
                {
                    ...
                    return RedirectToAction("PharmacyExamResults");
                }
                catch (Exception ex)
                {
        ...
        [HttpGet]
        public async Task<IActionResult> PharmacyExamResults()
        {
            var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
            var collegeCode = HttpContext.Session.GetString("CollegeCode");
            ...
            var model = new List<NursingExamResultViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> PharmacyExamResults(List<NursingExamResultViewModel> model)
        {
            try
            {
                var facultyCodeStr = HttpContext.Session.GetString("FacultyCode");
                ...
                return RedirectToAction(nameof(PharmacyExamResults));
            }
            catch (Exception ex)
            {
