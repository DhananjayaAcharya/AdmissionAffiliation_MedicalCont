...
namespace Medical_Affiliation.Services.Faculty
{
    public class CADentalLandBuildingPreviewService : ICADentalLandBuildingPreviewService
    {
        ...
        public async Task<DentalCollegeLandBuildingViewModel> GetDentalLandBuildingPreviewAsync()
        {
            ...
            vm.PrincipalStaffResidentialQuarter = entity.PrincipalStaffResidentialQuarter;
            vm.PrincipalStaffResidentialQuarterAreaSqFt = entity.PrincipalStaffResidentialQuarterAreaSqFt;

            vm.OtherStaffResidentialQuarter = entity.OtherStaffResidentialQuarter;
            vm.OtherStaffResidentialQuarterAreaSqFt = entity.OtherStaffResidentialQuarterAreaSqFt;

            vm.TeachingAncillaryStaffResidentialQuarter = entity.TeachingAncillaryStaffResidentialQuarter;
            vm.TeachingAncillaryStaffResidentialQuarterAreaSqFt = entity.TeachingAncillaryStaffResidentialQuarterAreaSqFt;
