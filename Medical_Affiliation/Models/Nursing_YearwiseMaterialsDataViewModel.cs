...
namespace Medical_Affiliation.Models
{
    ...
    public class ParentHospitalViewModel
    {
        public string CollegeCode { get; set; }
        public string ParentHospitalName { get; set; }
        public string ParentHospitalAddress { get; set; }
        ...
        public List<Nursing_YearwiseMaterialsDataViewModel> YearwiseMaterials { get; set; }
    }
    public class YearwisePivotRecord
    {
        public int Id { get; set; }
        public string HospitalType { get; set; }
        public string ParentHospitalName { get; set; }
        ...
        public Dictionary<string, YearwiseValues> Parameters { get; set; }
    }

    public class YearwiseValues
    {
        public int ParametersId { get; set; }
        public int Id { get; set; }
        public string Year1 { get; set; }
